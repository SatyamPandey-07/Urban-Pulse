...
data class TripPlan(
    ...
    /** "groq_ai" when genuinely generated by a live Groq call, "offline_estimate" when the
     *  Groq call was unavailable/failed and a scripted template was used instead — lets the UI
     *  avoid claiming "Verified" for content that wasn't actually produced by the AI or fetched live. */
    val source: String = "offline_estimate"
) : Serializable
